"""
Django settings for demo_44328 project.
...
WSGI_APPLICATION = 'demo_44328.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_44328 API",
    "DESCRIPTION": "API documentation for demo_44328 App",
    "VERSION": "v1",
}
